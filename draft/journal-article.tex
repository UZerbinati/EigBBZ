...
\begin{remark}
  We would like to point out that \eqref{eq:approxSigma} for $\mathbb{P}_k$ Lagrangian elements with $k\geq 4$ is a consequence of the best approximation estiamtes presented in \cite[Theorem 4.1]{Suri} together with the use of the Poincaré inequality for functions with null integral average.
\end{remark}
